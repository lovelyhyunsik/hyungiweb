        ...
        startZoom: function () {
            ...
            function getWindowZoomStyle() {
                return {
                    display: 'none',
                    position: 'absolute',
                    height: /* self.options.zoomWindowHeight */"100%",
                    width: /* self.options.zoomWindowWidth */"100%",
                    border: /* '' + self.options.borderSize + 'px solid ' + self.options.borderColour */"1px solid #e2e2e2",
            ...
            function getWindowLensStyle() {
                ...
                return {
                    ...
                    cursor: /* self.options.cursor */'url(./img/icon/ic_outline-zoom-in.png) , url(./img/icon/ic_outline-zoom-in.cur) , auto',
                    zIndex: 222,
                    overflow: 'hidden'//줌 렌즈
                };
            }
            ...
            self.zoomWindowContainer = $('<div class="zoomWindowContainer" />')
                .css({
                    width: /* self.options.zoomWindowWidth */"572px"
                });
